        ...
        <div class="login-content">
            ...
            <div class="login-right">
                ...
                <div class="right-footer">
                    ...
                    <span class="login-comments">遇到账号问题或操作问题，您可随时致电客户经理或拨打客服热线&nbsp;<em style="color: red;">400-032-7301</em></span>
                </div>
            </div>
        </div>
    </div>
...
export default {
    ...
    methods: {
        login() {
            ...
            params.password = this.$md5(this.pwd + this.salt);
            params.isRememberMe = this.isAutoLogin;

            this.$serv.login(params).then(data => {
                Alert({
                    type: 'success',
                    message: '登录成功！'
                });
