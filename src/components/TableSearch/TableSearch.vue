                        ...
                        template(
                           v-if="column.action"
                            ...
                            template(v-for="ac in column.action")
                                el-button(v-if="ac==='update'" type="primary" size="small" @click="showDialog({data: scope.row, update: true, title:'编辑'})") 编辑
                                el-button(v-if="ac==='delete'" type="primary" size="small" @click="deleteRow(scope.row, scope.$index)") 删除
                        table-expand(
                            v-if="column.render"
